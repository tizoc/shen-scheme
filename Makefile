...
COMPILED_DEPS = generate-scm.sld shen.sld shen/primitives.sld shen/primitives.scm shen/reader.sld shen/reader.scm
...
$(COMPILED_DIR)/%.kl.scm: $(KLSOURCES_DIR)/%.kl generate-scm.sld 
	$(CHIBI) -m generate-scm -e '(compile)' < $< > $@
