(define-library (shen)
  ...
  (begin      
    ...
    ($$eval-kl-file "../../K Lambda/toplevel.kl")
    ($$eval-kl-file "../../K Lambda/core.kl")
    ($$eval-kl-file "../../K Lambda/sys.kl")
    ($$eval-kl-file "../../K Lambda/sequent.kl")
    ($$eval-kl-file "../../K Lambda/yacc.kl")
    ($$eval-kl-file "../../K Lambda/reader.kl")
    ($$eval-kl-file "../../K Lambda/prolog.kl")
    ($$eval-kl-file "../../K Lambda/track.kl")
    ($$eval-kl-file "../../K Lambda/load.kl")
    ($$eval-kl-file "../../K Lambda/writer.kl")
    ($$eval-kl-file "../../K Lambda/macros.kl")
    ($$eval-kl-file "../../K Lambda/declarations.kl")
    ($$eval-kl-file "../../K Lambda/types.kl") 
    ($$eval-kl-file "../../K Lambda/t-star.kl")
